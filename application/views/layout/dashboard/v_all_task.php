                ...
                <div class="row">
                    <div class="col-lg-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="default-tab">
                                        <ul class="nav nav-tabs mb-3" role="tablist">
                                            <li class="nav-item" class="active"><a class="nav-link active" data-toggle="tab" href="#all">All Task</a>
                                            </li>
                                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="<?= site_url('index.php/dashboard/task/pending') ?>">Pending</a>
                                            </li>
                                                    ...
                                                    <li>
                                                        <div class="email-list m-t-15">
                                                            <div class="message">
                                                                <div class="col-mail col-mail-1">
                                                                    <div class="email-checkbox">
                                                                        <input type="checkbox" class="chk-sub" id="chk-sub-<?= $sub_task->subtask_id ?>" data-id="<?= $sub_task->subtask_id ?>" <?= $checked_subtask ?>>
                                                                        <!-- <label class="toggle" for="chk2"></label> -->
                                                                    </div>
                                                                </div>
                                                                <div class=" col-mail col-mail-2">
                                                                    <div class="subject" style="<?= $style_subtask ?>" id="subtask_name_<?= $sub_task->subtask_id ?>">
                                                                        <a href="#" data-toggle="modal" data-target="#modalEditSub<?= $sub_task->subtask_id; ?>">
                                                                    ...
                                                                    <div class="date">
                                                                        <div class="dropdown custom-dropdown">
                                                                            ...
                                                                            <a class="dropdown-item" href="javascript:void(0);" data-toggle="modal" data-target="#modalDeleteSub<?= $sub_task->subtask_id; ?>"><i class="ti-trash"></i></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                        ...
                        <div class="modal fade" id="modalAdd">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="<?= base_url('index.php/dashboard/task/save') ?>" method="POST" id="form">
                        ...
                        foreach ($allTasks as $data_task) :
                            ...
                            $date = date('m/d/Y', strtotime($str_rep));
                            /* h:i:s to h:i */
                            $var = $data_task->task_time;
                            $time = date("H:i", strtotime($var));
                        ?>
                            <form action="<?= base_url() . 'index.php/dashboard/task/edit' ?>" method="POST">
                        ...
                        <!-- Modal Edit-->
                        <!-- Modal Delete-->
                        <?php foreach ($allTasks as $data_task) : ?>
                        ...
                        foreach ($allTasks as $data_task) :
                        ?>
                            <form action="<?= base_url() . 'index.php/dashboard/Task/save_subtask' ?>" method="POST">
                        ...
                        foreach ($allTasks as $data_task) :
                            foreach ($data_task->subtask as $sub_task) :
                        ?>
                                <form action="<?= base_url() . 'index.php/dashboard/Task/edit_subtask' ?>" method="POST">
                        ...
                        foreach ($allTasks as $data_task) :
                            foreach ($data_task->subtask as $sub_task) :
                        ?>
                                <form action="<?= base_url() . 'index.php/dashboard/Task/delete_subtask' ?>" method="POST">
