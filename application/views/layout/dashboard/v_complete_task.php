                            ...
                            <div class="col-12">
                                ...
                                <div class="default-tab">
                                    <ul class="nav nav-tabs mb-3" role="tablist">
                                        ...
                                        <li class="nav-item" class="active"><a class="nav-link active" data-toggle="tab" href="<?= site_url('index.php/dashboard/Task/pending') ?>">Pending</a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#complete">Complete</a>
                                        </li>
                                    </ul>
