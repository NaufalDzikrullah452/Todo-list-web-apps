                                ...
                                <div class="card">
                                    ...
                                    <div class="default-tab">
                                        <ul class="nav nav-tabs mb-3" role="tablist">
                                            ...
                                            <li class="nav-item" class="active"><a class="nav-link" href="<?= site_url('index.php/dashboard/task/pending') ?>">Pending</a>
                                            </li>
                                            <li class="nav-item"><a class="nav-link active" href="<?= site_url('index.php/dashboard/task/complete') ?>">Complete</a>
                                            </li>
                                        </ul>
