                                        ...
                                        <div class="message">
                                            <a href="email-read.html">
                                                ...
                                                <div class="col-mail col-mail-2">
                                                    <div class="subject" id="task1">My Todo List </div>
                                            </a>
                                            <div class="date">
                                                <div class="dropdown custom-dropdown">
                                    ...
                                    <div class="modal-body">
                                        <form action="" method="POST" id="form">
                                            <div class="form-group">
                                                <label>Title:</label>
                                                <input type="text" class="form-control form-control-sm input-default" placeholder="title task" name="task_name" id="task_name">
                                            </div>
                                            <div class="form-group">
        ...
        <script>
            ...
            function fetch() {
                $.ajax({
                    ...
                    dataType: "json",
                    success: function(data) {
                        $('#task1').text(data.posts[0].task_name);
                    }
                });
            }
